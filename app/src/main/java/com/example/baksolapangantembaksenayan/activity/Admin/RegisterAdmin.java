...
public class RegisterAdmin extends AppCompatActivity {
    ...
    private void validate() {
        ...
        if (TextUtils.isEmpty( password )) {
            Snackbar.make( findViewById( R.id.register_admin ), "Masukkan password..", Snackbar.LENGTH_SHORT ).show();
            return;
        }
        if (password.length() < 6) {
            Snackbar.make( findViewById( R.id.register_admin ), "Password minimal 6 karakter..", Snackbar.LENGTH_SHORT ).show();
            return;
        }
        if (password.length() > 6) {
            Snackbar.make( findViewById( R.id.register_admin ), "Password minimal 6 karakter..", Snackbar.LENGTH_SHORT ).show();
        ...
        if (!ulangiPassword.equals( password )) {
            Snackbar.make( findViewById( R.id.register_admin ), "Password tidak sama..", Snackbar.LENGTH_SHORT ).show();
            return;
        }
        if (!checkBox.isChecked()) {
            Snackbar.make( findViewById( R.id.register_admin ), "Setujui syarat dan ketentuan..", Snackbar.LENGTH_SHORT ).show();
            return;
        }
        saveData();
    }
        ...
        firebaseAuth.createUserWithEmailAndPassword( email, password )
                ...
                .addOnFailureListener( new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Snackbar.make( findViewById( R.id.register_admin ), "Pendaftaran gagal, mohon coba lagi ..", Snackbar.LENGTH_SHORT ).show();
                        return;
                    }
                } );
    }
            ...
            ref.child( firebaseAuth.getUid() ).setValue( hashMap )
                    .addOnSuccessListener( new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            loadingDialog.dismissDialog();
                            Toast.makeText( RegisterAdmin.this, "Pendaftaran berhasil ..", Toast.LENGTH_SHORT ).show();
                            finish();
                        }
                    } )
                    .addOnFailureListener( new OnFailureListener() {
