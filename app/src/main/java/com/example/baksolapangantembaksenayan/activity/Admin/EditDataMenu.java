...
public class EditDataMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productId = getIntent().getStringExtra( "IdProduk" );
    ...
    private void loadProductDetails() {
        ...
        ref.child( firebaseAuth.getUid() ).child( "Menu" ).child( productId )
                .addValueEventListener( new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        String IdProduk = "" + dataSnapshot.child( "IdMenu" ).getValue();
                        String deskripsiMenu = "" + dataSnapshot.child( "deskripsiMenu" ).getValue();
                        String namaMenu = "" + dataSnapshot.child( "namaMenu" ).getValue();
                        String gambarMenu = "" + dataSnapshot.child( "gambarMenu" ).getValue();
                        String kategoriMenu = "" + dataSnapshot.child( "kategoriMenu" ).getValue();
                        String satuanMenu = "" + dataSnapshot.child( "satuanMenu" ).getValue();
                        String hargaMenu = "" + dataSnapshot.child( "hargaMenu" ).getValue();


                        edtNamaMenu.setText( namaMenu );
                        txtKategori.setText( kategoriMenu );
                        txtSatuanProduk.setText( satuanMenu );
                        edtHargaMenu.setText( hargaMenu );
                        edtDeskripsi.setText( deskripsiMenu );
                        try {
                            Picasso.get().load( gambarMenu ).fit().into( imageMenu );
                        } catch (Exception e) {
    ...
    private void addProduct() {
        ...
        if (image_uri == null) {
            ...
            DatabaseReference ref = FirebaseDatabase.getInstance().getReference( "Users" );
            ref.child( firebaseAuth.getUid() ).child( "Menu" ).child( productId ).updateChildren( hashMap )
                    .addOnSuccessListener( new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void aVoid) {
                            progressDialog.dismissDialog();
                            Toast.makeText( EditDataMenu.this, "Menu di update ...", Toast.LENGTH_SHORT ).show();
                            clearData();
                            finish();
                        }
                    } )
                    .addOnFailureListener( new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            progressDialog.dismissDialog();
                            Toast.makeText( EditDataMenu.this, "" + e.getMessage(), Toast.LENGTH_SHORT ).show();
                        }
                    } );
            DatabaseReference reff = FirebaseDatabase.getInstance().getReference( "DataMenu" );
            reff.child( "Menu" ).child( productId ).updateChildren( hashMap )
                    .addOnSuccessListener( new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void aVoid) {
                            progressDialog.dismissDialog();
