...
import com.example.baksolapangantembaksenayan.activity.Admin.DetailOrderAdmin;
...
import com.example.baksolapangantembaksenayan.utility.FilterOrderAdmin;
...
public class Adapter_Transaction_Admin extends RecyclerView.Adapter<Adapter_Transaction_Admin.ViewHolder> implements Filterable {

    private Context context;
    public ArrayList<model_transaction> list,filterList;
    private FilterOrderAdmin filterOrderAdmin;

    public Adapter_Transaction_Admin(Context context, ArrayList<model_transaction> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        String status = model.getStatusOrder();
        ...
        if (status.equals( "Sedang Proses" )){
        ...
        holder.itemView.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( context, DetailOrderAdmin.class );
    ...
    public Filter getFilter() {
       if (filterOrderAdmin==null){
           filterOrderAdmin = new FilterOrderAdmin( this,filterList );
       }
